...
local Themes = {
	Names = {
		...
		"Github Darkest",
		"Github Darkest Dark",
		"Github Darkest Darker",
		"Github Darkest Darkest",
		"Github Darkest Darkest Dark"
	},
	GithubDarkBlue = {
		Name = "Github Dark Blue",
		Accent = Color3.fromRGB(44, 42, 156),
		AcrylicMain = Color3.fromRGB(31, 38, 173),
		AcrylicBorder = Color3.fromRGB(64, 79, 125),
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(31, 38, 173)),
			ColorSequenceKeypoint.new(0.25, Color3.fromRGB(23, 15, 133)),
			ColorSequenceKeypoint.new(0.50, Color3.fromRGB(31, 24, 181)),
			ColorSequenceKeypoint.new(0.75, Color3.fromRGB(45, 78, 110)),
			ColorSequenceKeypoint.new(1, Color3.fromRGB(33, 34, 86)),
		},
		AcrylicNoise = 0.92,
	...
	GithubDarkNeon = {
		Name = "Github Dark Neon",
		Accent = Color3.fromRGB(255, 23, 100),
		AcrylicMain = Color3.fromRGB(187, 218, 255),
		AcrylicBorder = Color3.fromRGB(187, 218, 255),
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(187, 218, 255)),
			ColorSequenceKeypoint.new(0.25, Color3.fromRGB(255, 23, 100)),
			ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 105, 36)),
			ColorSequenceKeypoint.new(0.75, Color3.fromRGB(255, 199, 50)),
			ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 255, 255)),
		},
		AcrylicNoise = 0.1,
		TitleBarLine = Color3.fromRGB(255, 23, 100),
		Tab = Color3.fromRGB(255, 245, 245),
		Element = Color3.fromRGB(0, 0, 0),
		ElementBorder = Color3.fromRGB(255, 23, 100),
		InElementBorder = Color3.fromRGB(255, 105, 36),
		ElementTransparency = 0.5,
		ToggleSlider = Color3.fromRGB(255, 105, 36),
		ToggleToggled = Color3.fromRGB(0, 0, 0),
		SliderRail = Color3.fromRGB(255, 105, 36),
		DropdownFrame = Color3.fromRGB(0, 0, 0),
		DropdownHolder = Color3.fromRGB(0, 0, 0),
		DropdownBorder = Color3.fromRGB(255, 23, 100),
		DropdownOption = Color3.fromRGB(255, 245, 245),
		Keybind = Color3.fromRGB(0, 0, 0),
		Input = Color3.fromRGB(0, 0, 0),
		InputFocused = Color3.fromRGB(0, 0, 0),
		InputIndicator = Color3.fromRGB(255, 23, 100),
		Dialog = Color3.fromRGB(0, 0, 0),
		DialogHolder = Color3.fromRGB(0, 0, 0),
		DialogHolderLine = Color3.fromRGB(255, 23, 100),
		DialogButton = Color3.fromRGB(0, 0, 0),
		DialogButtonBorder = Color3.fromRGB(255, 23, 100),
		DialogBorder = Color3.fromRGB(255, 245, 245),
		DialogInput = Color3.fromRGB(0, 0, 0),
		DialogInputLine = Color3.fromRGB(255, 105, 36),
		Text = Color3.fromRGB(255, 245, 245),
		SubText = Color3.fromRGB(255, 245, 245),

local Library = {
	Version = "1.1.0", -- config if u want
